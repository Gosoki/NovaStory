...
def build_system_guidance_round1(lang: str = _DEFAULT_LANG) -> str:
    ...
    if _norm(lang) == "zh":
        return (
            ...
            "(dimension 用简短英文 slug,如 \"pacing\"、\"tone\"、\"ending\"、\"sound\");若创意适用,优先补一个 \"pacing\"(如何把 15 秒分配给 3 个镜头、节奏快慢)。\n"
    ...
    return (
        ...
        "(dimension は短い英語スラッグ、例:\"pacing\"、\"tone\"、\"ending\"、\"sound\");アイデアに合えば、まず \"pacing\"(15秒を3カットにどう配分するか・テンポ)を優先して補うこと。\n"
